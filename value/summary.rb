...
class Summary
  ...
  def initialize call_number, message_id, from, n_subject, date, body
  ...
  def self.from message
    ...
    new(message.call_number, message.message_id, message.from, message.n_subject, message.date, message.body)
  end
